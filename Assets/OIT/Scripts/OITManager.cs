...
public class OITManager : MonoBehaviour {
    ...
    private TransparentMode m_lastMode = TransparentMode.ODT;
    ...
    private void _OnODTRender() {
    }

    private void _OnMeshkinRender() {}

    private void _OnBavoilAndMyersRender() {}

    private void _OnBlendedRender() {}

    private void _OnBlendedAndWeightedRender() {}
